...
- - `./skills/handoff/SKILL.md`: Crystallise the current conversation into a plan, save it to the session workspace, and give the user an exact prompt to paste into a fresh session to implement it. Use when the user says "handoff". If the user mentions a worktree with "handoff", use `handoff-to-worktree` skill.
- `./skills/handoff-to-worktree/SKILL.md`: Crystallise the current conversation into a plan, save it to the session workspace, and give the user an exact prompt to paste into a fresh session to implement it. Use when the user says "handoff" with the word "worktree", otherwise just use the `handoff` skill.
