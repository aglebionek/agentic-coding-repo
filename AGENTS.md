...
- `skills/agent-invoked/engineering/testable-module/SKILL.md` — Use when behavior
  needs a stable public module contract and deterministic test seam before TDD.
