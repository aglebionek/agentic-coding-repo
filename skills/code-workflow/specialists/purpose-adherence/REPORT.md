...
report for the target selected by the active profile. Do not modify code, types,
tests, documentation, the Git index, or snapshots. Emit the report in
conversation unless the work package supplies a report path.
