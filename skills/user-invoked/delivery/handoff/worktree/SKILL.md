...
./scripts/createWorktree.sh <branch-name>
...
- `./scripts/createWorktree.sh <branch-name>`: Creates a new git worktree for the session, sets up symlinks for shared resources, and saves session metadata.
