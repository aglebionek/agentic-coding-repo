---
name: coding-standards-accordance-report
description: Audits JavaScript and TypeScript against the governing CODING_GUIDELINES.md. Use only when the user invokes "coding-standards-accordance report <file-or-directory>", "coding-standards-accordance report codebase", or "coding-standards-accordance report current changes".
---
